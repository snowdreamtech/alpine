...
* add rocket icon to performance workflow name ([e6a6146](https://github.com/snowdreamtech/alpine/commit/e6a61461a6315e84e993d6edfc618ef61f27003e))
* add UNIRTM_HOOK_ALLOW_MISSING=1 to .unirtm.toml ([a1ceab9](https://github.com/snowdreamtech/alpine/commit/a1ceab9944841fe017617af3d39a777358ac2a1c))
...
* **ci:** add GitHub API rate limit info to summary reports ([8c4293a](https://github.com/snowdreamtech/alpine/commit/8c4293afbd82f74278af2db4ecb77abf6a9b1aab))
* **ci:** enable auto-merge for ALL dependabot updates including major ([9c8bae2](https://github.com/snowdreamtech/alpine/commit/9c8bae233e0e8834a611370dc897ac67db64057a))
...
* **ci:** sync harden runner endpoints from centralized config ([4412a8b](https://github.com/snowdreamtech/alpine/commit/4412a8b375b98384edfe9b79b2b1a38b91fc764d))
...
* **deps:** consolidate all dependabot updates into single PR ([e753902](https://github.com/snowdreamtech/alpine/commit/e753902201ce2f059747de31b59681442bb149b0))
* **deps:** optimize dependabot configuration and grouping strategy ([900f3af](https://github.com/snowdreamtech/alpine/commit/900f3aff782a709643b81f9721a45da7a0d10a87))
...
* **docker:** add multi-platform alpine docker build pipeline ([567746f](https://github.com/snowdreamtech/alpine/commit/567746f19f1656d00b9678b796e2b67f72b8125a))
* **docker:** add support for alpine 3.24.0 ([85f4a18](https://github.com/snowdreamtech/alpine/commit/85f4a181d5458b5ca5e2801a2cbf86f0c89b0f0e))
...
* **security:** add CDN and download mirror endpoints to harden runner ([3ff8a5d](https://github.com/snowdreamtech/alpine/commit/3ff8a5d3d073a57bb4681c619e94aa797983ef23))
* **security:** add docker.yml to harden runner workflow profiles ([78c70f1](https://github.com/snowdreamtech/alpine/commit/78c70f1c656276457623619e7e11fe7fa9702a92))
* **security:** add DockerHub endpoints to harden runner ([48b6416](https://github.com/snowdreamtech/alpine/commit/48b6416ced65a68194a50d4ffb406c7e7257a37f))
...
* **workflow:** configure docker build matrix for alpine 3.24.0 ([d3b2738](https://github.com/snowdreamtech/alpine/commit/d3b27383d01d6cea10ea66a696e0487bfcad0f0b))
* **workflow:** remove main branch push trigger to avoid duplicate builds with release-please tags ([cb0c4ae](https://github.com/snowdreamtech/alpine/commit/cb0c4ae55120d9e8bf5e9547917f66c63ffab04c))
...
* **ci:** disable shellcheck integration in actionlint to prevent Windows hang ([1d711d8](https://github.com/snowdreamtech/alpine/commit/1d711d8c1bc4c7482651f1abe228c970ba6f024c))
...
* **ci:** replace head -n -1 with sed for macOS compatibility ([67aaa95](https://github.com/snowdreamtech/alpine/commit/67aaa95afe68cdfcade622a3478fe3b0b000ccca))
...
* **deps:** correct devcontainers directory to root ([9d83806](https://github.com/snowdreamtech/alpine/commit/9d838067e3fb82e84c1107f0036cc4a7b7855f56))
* **deps:** correct indentation in test script for editorconfig compliance ([0a44088](https://github.com/snowdreamtech/alpine/commit/0a44088beafca6ea70111f98062e1889d21c069f))
* **deps:** exclude .devcontainer from docker ecosystem detection ([67e96c3](https://github.com/snowdreamtech/alpine/commit/67e96c3c1b94c72811d81af229a017f927fd3de4))
...
* **docker:** correct OCI image version fallback to match FROM base ([a08305f](https://github.com/snowdreamtech/alpine/commit/a08305f065633e816181423cea127c0bae1c79b9))
* **docker:** improve cosign signing resilience and error handling ([c34a761](https://github.com/snowdreamtech/alpine/commit/c34a761d45e11b1fba12694d6d43c495ed9dcf2f))
* **docker:** resolve ci linting errors ([ee6e7d6](https://github.com/snowdreamtech/alpine/commit/ee6e7d6ca157f9d2887cf11df8ae362ecedce3a4))
* **docker:** resolve shellcheck warnings in workflow ([a68c2be](https://github.com/snowdreamtech/alpine/commit/a68c2be4771f819c22a6118924001911d0077e3d))
* **docker:** revert to correct minor versions and restrict dependabot minor/major updates ([1d5c9c3](https://github.com/snowdreamtech/alpine/commit/1d5c9c3c160a46a05b0875cac9219bce53b7486c))
* **docker:** update all Alpine variants for new release ([efe79b5](https://github.com/snowdreamtech/alpine/commit/efe79b5d87055813b7de3458bd88ba335b5cf703))
* **docker:** update all Alpine variants to trigger version bump ([beadbbd](https://github.com/snowdreamtech/alpine/commit/beadbbde141d27dd7ec5867e2a20ee06394dfdec))
...
* **package:** update project metadata from template to alpine ([359fba9](https://github.com/snowdreamtech/alpine/commit/359fba99f81efef9165269452008d1b8909d726f))
...
* **release:** add extra-files config to update Dockerfile versions automatically ([f855266](https://github.com/snowdreamtech/alpine/commit/f85526699395f45a4599bf35adcbab0a88d8a8f4))
* **release:** align versions with release-please calculations ([3c0806f](https://github.com/snowdreamtech/alpine/commit/3c0806f6ba6ca7366c5c44ff83c82f6c9b90e4e1))
* **release:** correct changelog-path to be relative to package directory ([bf0ceb3](https://github.com/snowdreamtech/alpine/commit/bf0ceb3214074501c3ddbf3820e2393bd79d268e))
* **release:** enable multi-version tags in release-please ([aae04cc](https://github.com/snowdreamtech/alpine/commit/aae04cc621de99f09ec1d69eac3e658c710ce6cb))
...
* **security:** add template-injection rule to zizmor config ([6885421](https://github.com/snowdreamtech/alpine/commit/68854213181ac760756c23c7f4493b2c924be9b5))
...
* **tasks:** make osv-scanner recursive and allow missing lockfiles ([fc5913d](https://github.com/snowdreamtech/alpine/commit/fc5913dd652471ee4ffc343646a7a5ca3f915fec))
...
* **docs:** explicitly add esbuild and vite to devDependencies for tracking ([ea50d16](https://github.com/snowdreamtech/alpine/commit/ea50d166a8f149e4892180ffb28f0259a7a95367))
...
* **release:** 3.21 3.21.5  🚀 ([ed98c1d](https://github.com/snowdreamtech/alpine/commit/ed98c1dbbaeb0e48ec61f7e6751bda7f7c65ed2f))
* **release:** 3.22 3.22.2  🚀 ([4f9da4d](https://github.com/snowdreamtech/alpine/commit/4f9da4d0c6713e4c32907997e116baa62c0a4828))
* **release:** 3.23 3.23.2 🚀 ([925c611](https://github.com/snowdreamtech/alpine/commit/925c611cd51ce6af3dc9067d10e38bb9051d9320))
* **release:** initialize multi-version releases ([aec08d3](https://github.com/snowdreamtech/alpine/commit/aec08d352168420d5f68ee3ef1a4eabd0b527b53))
