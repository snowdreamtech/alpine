...
Based on performance testing (see [Performance Testing](../../benchmarks/README)):
...
- [Performance Testing](../../benchmarks/README)
...
- [Performance Testing Spec](../../.kiro/specs/performance-testing-and-docs/design)
