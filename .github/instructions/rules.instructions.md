...
After reading the core rules, **inspect the project's file structure and configuration files** to identify the languages and frameworks in use. Then read the corresponding rule files from `.agent/rules/`.
