...
GOLANGCI_VERSION="${GOLANGCI_VERSION:-v1.61.0}"
CHECKMAKE_VERSION="${CHECKMAKE_VERSION:-v0.2.1}"
TFLINT_VERSION="${TFLINT_VERSION:-v0.53.0}"
KUBE_LINTER_VERSION="${KUBE_LINTER_VERSION:-v0.6.0}"
JAVA_FORMAT_VERSION="${JAVA_FORMAT_VERSION:-1.23.0}"
PHP_CS_FIXER_VERSION="${PHP_CS_FIXER_VERSION:-v3.64.0}"
