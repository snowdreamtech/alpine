...
# Tool Versions (SSoT)
GITLEAKS_VERSION="${GITLEAKS_VERSION:-v8.23.3}"
...
TFLINT_VERSION="${TFLINT_VERSION:-v0.55.0}"
KUBE_LINTER_VERSION="${KUBE_LINTER_VERSION:-v0.8.1}"
JAVA_FORMAT_VERSION="${JAVA_FORMAT_VERSION:-1.25.0}"
PHP_CS_FIXER_VERSION="${PHP_CS_FIXER_VERSION:-v3.68.5}"
